...
<div class="goods_list">
	...
	<c:forEach items="${pageBean.goodsList }" var="goods" varStatus="status">
		...
		<!-- varStatus显示for循环的脚标 -->
	        ...
	        <li><img src="${pageContext.request.contextPath }/admin/images/pimages/goods_001.png" alt=""></li>
	        <li>${goods.name }</li>
	        <li>${goods.price }</li>
	        <li><a href="${pageContext.request.contextPath }/GoodsServlet?action=EditUI&id=${goods.id}"><img class="img_icon" src="${pageContext.request.contextPath }/admin/images/edit_icon.png" alt=""></a></li>
	        <li><a href="${pageContext.request.contextPath }/GoodsServlet?action=delGoods&id=${goods.id}"><img class="img_icon" src="${pageContext.request.contextPath }/admin/images/delete_icon.png" alt=""></a></li>
    	</ul>
...
<script>
    ...
    $("#page").paging({
        ...
        callback: function(num) {
            $(window).attr('location','${pageContext.request.contextPath }/GoodsServlet?action=getPageDate&currentPage='+num);
        }
    });
 
    $("#add").click(function () {
        $(window).attr('location','${pageContext.request.contextPath }/GoodsServlet?action=AddUI');
    });
