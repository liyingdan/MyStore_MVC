...
<div class="main_top">
    ...
    <div class="edit_content">
		<form action="${pageContext.request.contextPath }/GoodsServlet?action=editGoods" id="edit_form" method="post" style="background: none; width: 700px">
	        <div class="item1">
...
<script>
	$(function(){
		...
		//让value的值等于商品is_hot的optioon(id为"isHotSel")成为选中状态 
